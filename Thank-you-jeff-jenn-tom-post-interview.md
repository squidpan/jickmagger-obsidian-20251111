...
I am wondering whether the dashboard UI already has the self-service features built into it but requires understanding the current practice (mostly through IT resources outside of UI) so that they can be done using the Dashboad UI?
